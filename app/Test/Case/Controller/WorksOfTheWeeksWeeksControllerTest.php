<?php
App::uses('WorksOfTheWeeksWeeksController', 'Controller');

/**
 * WorksOfTheWeeksWeeksController Test Case
 *
 */
class WorksOfTheWeeksWeeksControllerTest extends ControllerTestCase {
