<?php
App::uses('NewWorksInLikeGalleriesController', 'Controller');

/**
 * NewWorksInLikeGalleriesController Test Case
 *
 */
class NewWorksInLikeGalleriesControllerTest extends ControllerTestCase {
