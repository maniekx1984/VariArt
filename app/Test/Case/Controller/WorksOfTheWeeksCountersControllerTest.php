<?php
App::uses('WorksOfTheWeeksCountersController', 'Controller');

/**
 * WorksOfTheWeeksCountersController Test Case
 *
 */
class WorksOfTheWeeksCountersControllerTest extends ControllerTestCase {
