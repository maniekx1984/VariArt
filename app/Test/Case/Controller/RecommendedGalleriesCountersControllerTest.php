<?php
App::uses('RecommendedGalleriesCountersController', 'Controller');

/**
 * RecommendedGalleriesCountersController Test Case
 *
 */
class RecommendedGalleriesCountersControllerTest extends ControllerTestCase {
