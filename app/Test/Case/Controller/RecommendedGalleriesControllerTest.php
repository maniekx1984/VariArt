<?php
App::uses('RecommendedGalleriesController', 'Controller');

/**
 * RecommendedGalleriesController Test Case
 *
 */
class RecommendedGalleriesControllerTest extends ControllerTestCase {
